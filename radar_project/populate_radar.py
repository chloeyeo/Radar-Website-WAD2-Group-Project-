...
def populate():
    cartoon = [
        ...
        {'title' : 'Enchanted Forest','views':24, 'likes':15, 'image': "/images/frozen.jpg", 'description':"Olaf. The Enchanted Forest is a location in Disney's 2019 animated feature film Frozen II. It is a dense, magical forest inhabited by the spirits of nature, and the Northuldra people."},
